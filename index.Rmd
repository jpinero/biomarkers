...
Using this pipeline, we have processed 398,516 clinical studies available at CT.gov, carried out between 1999 and 2021. We found over 43,000 clinical studies measuring 3,100 biomarkers for 2,600 diseases. The clinical trial have been carried out between 1999 and 2021. Figure 2 shows the trends in the use of biomarker across all therapeutic areas in these 20 years. 
...
Figure 3 shows the number of biomarkers  across all therapeutic areas in these 20 years.  [Here](Conditions.html) is a selection of the top 100 conditions by number of clinical trials in the dataset.
...
In Figure we show an example of the 50 most commonly used biomarkers for liver failure. 

```{r, warning=FALSE, fig.cap = 'Figure 1: Clinical Trials by therapeutic area per year.', message=FALSE,echo = FALSE, fig.width = 8}
library(data.table)
library(dplyr)
library(tidyr)
library(ggrepel)
